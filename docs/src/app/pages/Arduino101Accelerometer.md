...
<strong>More links:</strong><ul><li>Download a <a href='http://iot.appinventor.mit.edu/resources/SampleArduino101Accelerometer.aia' target='_blank'>sample AIA</a> for the Arduino 101 Accelerometer.</li><li>View the <a href='http://iot.appinventor.mit.edu/assets/howtos/MIT_App_Inventor_Arduino101Accelerometer.pdf' target='_blank'>how to instructions</a> for the Arduino 101 Accelerometer.</li></ul>
