...
The Microbit_Io_Pin componet lets users configure the Micro:bit's analog pins for input and output, and to read, write, and request notifications for theI/O pin states. 
